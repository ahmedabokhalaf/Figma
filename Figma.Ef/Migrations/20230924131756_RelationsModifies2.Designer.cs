...
namespace Figma.Ef.Migrations
{
    ...
    [Migration("20230924131756_RelationsModifies2")]
    partial class RelationsModifies2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationsQuestions", b =>
                {
                    ...
                    b.ToTable("ApplicationsQuestions");
                });
            ...
            modelBuilder.Entity("ApplicationsQuestions", b =>
                {
                    b.HasOne("Figma.Core.Models.ApplicationForm", null)
                        .WithMany()
                        .HasForeignKey("ApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Figma.Core.Models.Question", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Figma.Core.Models.ApplicationForm", b =>
                {
                    b.HasOne("Figma.Core.Models.Profile", "Profile")
                        ...
                        .HasForeignKey("Figma.Core.Models.ApplicationForm", "ProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Figma.Core.Models.FigmaProgram", b =>
                {
                    b.HasOne("Figma.Core.Models.ApplicationForm", "Application")
                        .WithOne("FigmaProgram")
                        .HasForeignKey("Figma.Core.Models.FigmaProgram", "ApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Figma.Core.Models.Stage", b =>
                {
                    b.HasOne("Figma.Core.Models.FigmaProgram", "Program")
                        .WithOne("Stage")
                        .HasForeignKey("Figma.Core.Models.Stage", "ProgramId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
